...
//
// Module: registers.v
// Project: Event Capture Router (router_buffer_sizing)
// Description: Project specific register defines
//
//              Router with event capture (buffer occupancy tracking)
//
///////////////////////////////////////////////////////////////////////////////
...
`define DEVICE_PROJ_DIR    "router_buffer_sizing"
`define DEVICE_PROJ_NAME   "Event Capture Router"
`define DEVICE_PROJ_DESC   "Router with event capture (buffer occupancy tracking)"
...
`define OQ_BLOCK_ADDR_WIDTH             NaN
`define OQ_REG_ADDR_WIDTH               NaN
...
`define RATE_LIMIT_0_BLOCK_ADDR   19'h00008
`define RATE_LIMIT_1_BLOCK_ADDR   19'h00009
`define RATE_LIMIT_2_BLOCK_ADDR   19'h0000a
`define RATE_LIMIT_3_BLOCK_ADDR   19'h0000b
`define EVT_CAP_BLOCK_ADDR        17'h00003
`define OQ_BLOCK_ADDR             NaN'hN
...
//   Address decompositions:
//     - Inst:  Addresses of the *instances* within the module
`define OQ_QUEUE_INST_BLOCK_ADDR_WIDTH    NaN
`define OQ_QUEUE_INST_REG_ADDR_WIDTH      7

`define OQ_QUEUE_0_INST_BLOCK_ADDR  NaN'd0
`define OQ_QUEUE_1_INST_BLOCK_ADDR  NaN'd1
`define OQ_QUEUE_2_INST_BLOCK_ADDR  NaN'd2
`define OQ_QUEUE_3_INST_BLOCK_ADDR  NaN'd3
`define OQ_QUEUE_4_INST_BLOCK_ADDR  NaN'd4
`define OQ_QUEUE_5_INST_BLOCK_ADDR  NaN'd5
`define OQ_QUEUE_6_INST_BLOCK_ADDR  NaN'd6
`define OQ_QUEUE_7_INST_BLOCK_ADDR  NaN'd7
